...
const NAP = {
  ...
  zip:       "92506",
  country:   "US",
  phone:     "(951) 555-0100",        // TODO: replace with real phone
  phoneHref: "tel:+19515550100",      // TODO: replace with real phone
    ...
    <footer id="site-footer" className="relative bg-[#0a0a0a] overflow-hidden" role="contentinfo">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-16 pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-10 xl:gap-8">
          ...
          >
            <Link href="/" aria-label="Gra Pow home" className="inline-block self-start">
              <Image
                src={cldImage(ASSETS.logo, "h_100,f_auto,q_auto")}
            ...
            <p className="text-sm leading-relaxed max-w-[210px]"
            ...
            <div className="flex items-center gap-2.5" role="list" aria-label="Social media links">
              ...
              <a
                ...
                role="listitem"
                className="group flex items-center justify-center rounded-full transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#E8A000] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a0a0a]"
                style={{
              ...
              {/* TikTok */}
              <a
                href="https://www.tiktok.com/@grapow"
                target="_blank" rel="noopener noreferrer"
                aria-label="Follow Gra Pow on TikTok"
                role="listitem"
                className="flex items-center justify-center rounded-full transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#E8A000] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a0a0a]"
                style={{
                  width: 48, height: 48, flexShrink: 0, color: "rgba(156,163,175,1)",
                  background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.10)",
                  boxShadow: "inset 0 1px 1px rgba(255,255,255,0.07)",
              ...
              >
                <svg width="17" height="17" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.27 6.27 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.9a8.17 8.17 0 0 0 4.78 1.52V6.97a4.85 4.85 0 0 1-1.01-.28z" />
                </svg>
              </a>
          ...
          <nav aria-label="Footer navigation" className="flex flex-wrap justify-center gap-x-6 gap-y-2">
            {NAV.map((item) => (
              <Link
                key={item.href}
                href={item.href}
                className="text-[10px] tracking-[0.2em] uppercase transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#E8A000] rounded"
