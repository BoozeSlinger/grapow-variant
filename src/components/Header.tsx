      ...
      >
        <div className="flex items-center justify-between px-5 py-4 max-w-screen-2xl mx-auto">
          ...
          <div className="flex items-center gap-2 md:gap-3">
            <a href="https://www.instagram.com/grapow_ig/" target="_blank" rel="noopener noreferrer"
            ...
            <a href="https://www.facebook.com/p/Gra-Pow-100063506142426/" target="_blank" rel="noopener noreferrer"
